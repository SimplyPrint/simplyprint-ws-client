...
:class:`Websockets` is a 1:1 WebSocket :class:`~simplyprint_ws_client.common.wire.transport.WsTransport`
...
:class:`~simplyprint_ws_client.common.wire.transport.TransientError`, which ends
...
from simplyprint_ws_client.common.wire.errors import ErrorCode
...
class Websockets(WsTransport, Reconnecting):
    ...
    :class:`~simplyprint_ws_client.common.wire.policy.RetryPolicy`, the
    ...
    async def recv(self) -> WsMessage:
        ...
        :class:`~simplyprint_ws_client.common.wire.transport.TransientError` so the
