...
:class:`~simplyprint_ws_client.common.wire.reconnect.Reconnecting` transport: it
...
:class:`~simplyprint_ws_client.common.wire.transport.MqttTransport`, so it carries
...
class AioMqtt(MqttTransport, Reconnecting):
    ...
    async def open(self) -> None:
        ...
        :class:`~simplyprint_ws_client.common.wire.transport.FatalError` (auth) or
        a :class:`~simplyprint_ws_client.common.wire.transport.TransientError`.
        """
