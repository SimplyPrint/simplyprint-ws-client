...
from simplyprint_ws_client.common.wire.events import WireEvent
from simplyprint_ws_client.common.wire.errors import (
    FatalError,
    NotConnected,
    TransientError,
    TransportError,
...
class Transport(ABC):
    ...
    def start(self) -> None:
        ...
        reported through :class:`~simplyprint_ws_client.common.wire.events.Connected`.
        """
    ...
    def supervising(self) -> bool:
        ...
        :class:`~simplyprint_ws_client.common.wire.reconnect.Reconnecting`
