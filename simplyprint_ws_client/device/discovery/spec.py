...
from simplyprint_ws_client.device.discovery.ssdp import SSDPRequest

if TYPE_CHECKING:
    from simplyprint_ws_client.device.discovery.network import HostProbeContext
    from simplyprint_ws_client.device.discovery.mdns import MDNSResponse
