...
:class:`~simplyprint_ws_client.common.wire.transport.Transport` per endpoint key,
ref-counted, and hands every caller a :class:`~simplyprint_ws_client.device.connection.lease.Lease`
