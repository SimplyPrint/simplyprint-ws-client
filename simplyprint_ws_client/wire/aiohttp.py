...
:class:`Aiohttp` is a concrete :class:`~simplyprint_ws_client.wire.transport.WsTransport`
...
* :meth:`~Aiohttp.recv` -- await the next frame, surface a closed/errored socket as
  a :class:`~simplyprint_ws_client.wire.transport.TransientError`, and hand
...
class Aiohttp(WsTransport, Reconnecting):
    ...
    :class:`~simplyprint_ws_client.wire.policy.RetryPolicy`, an
