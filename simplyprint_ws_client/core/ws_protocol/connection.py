...
__all__ = ["Connection", "ConnectionHint", "ConnectionMode", "TransportFactory"]
...
from .messages import ClientMsg, ClientMsgType
...
from ...contrib.connection.websockets import Websockets
...
class Connection(
    ...
    The transport owns link lifecycle and frames. :class:`ClientProtocol` sits on top
    and owns message parsing, protocol events, and version state. ``Connection`` is
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.protocol = ClientProtocol(self, logger)
        self.event_bus: EventBus[ConnectionEvent] = self.protocol.event_bus
