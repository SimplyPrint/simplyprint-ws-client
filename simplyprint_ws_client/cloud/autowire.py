...
from simplyprint_ws_client.cloud.protocol.messages import ServerMsgKind, DemandMsgKind
...
if TYPE_CHECKING:
    from simplyprint_ws_client.cloud.client import Client  # noqa: F401
    from simplyprint_ws_client.cloud.state import PrinterState  # noqa: F401
