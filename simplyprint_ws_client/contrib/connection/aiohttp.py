...
:class:`Aiohttp` is a concrete :class:`~simplyprint_ws_client.contrib.connection.transport.WsTransport`
...
* :meth:`~Aiohttp.recv` -- await the next frame, surface a closed/errored socket as
  a :class:`~simplyprint_ws_client.contrib.connection.transport.TransientError`, and hand
