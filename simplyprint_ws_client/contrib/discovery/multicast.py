...
Drives one brand's :class:`~simplyprint_ws_client.contrib.discovery.spec.MulticastSpec`:
...
from simplyprint_ws_client.contrib.discovery.ssdp import SSDPRequestParser
